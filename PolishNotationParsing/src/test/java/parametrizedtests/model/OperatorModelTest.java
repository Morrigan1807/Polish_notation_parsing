...
public class OperatorModelTest {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = PATH_TO_OPERATOR_MODEL_TEST_DATA + TEST_DATA_FROM_STRING_CORRECT_CASE)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = PATH_TO_OPERATOR_MODEL_TEST_DATA + TEST_DATA_FROM_STRING_INCORRECT_CASE)
